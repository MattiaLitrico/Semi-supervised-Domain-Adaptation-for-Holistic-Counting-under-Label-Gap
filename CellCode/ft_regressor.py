...
def main():
    ...
    data_train = Cells(opt.data, mode='train', norm_label=False, train_perc=opt.train_perc)
    data_test = Cells(opt.data, mode='validation', norm_label=False, train_perc=opt.train_perc)
    ...
    optimizer = Adam(model.counting_part.parameters(), opt.lr, weight_decay=0.0) 
