...
def train_da(generator_s, generator_t, discriminator, counting_layers, c_loss, optimizer_gen, optimizer_dis, data, exp_name='experiment', epochs=50, logdir='logs', e_done=0, best=None):
