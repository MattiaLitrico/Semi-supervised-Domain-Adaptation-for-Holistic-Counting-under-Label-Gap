...
def main():
    ...
    data_train = Pedestrian("Pedestrian/"+opt.data, mode='train', norm_label=norm_label)
    data_test = Pedestrian("Pedestrian/"+opt.data, mode='validation', norm_label=norm_label)
