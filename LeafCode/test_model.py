...
def main():
    ...
    if opt.data == "CVPPP2017":
        data_test = CVPPP2017(opt.data, mode='test', norm_label=False)
        range = (4,32)
    elif opt.data == "Komatsuna":
        data_test = Komatsuna(opt.data, mode='test', norm_label=False, train_perc=None)
        range = (2,8)
    else:
        data_test = MultiModal(opt.data, mode='test', norm_label=False, train_perc=None)
        range = (5,12)
